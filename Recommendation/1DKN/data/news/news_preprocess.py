...
def construct_word2id_and_entity2id():
    ...
    writer = open(prefix + 'jgw_entity2index.txt', 'w', encoding='utf-8')
...
if __name__ == '__main__':
    ...
    count_word_and_entity_freq([prefix + 'jgw_raw_train.txt'])
    ...
    transform(prefix + 'jgw_raw_train.txt',prefix + 'jgw_train.txt')
    ...
    np.save((prefix + 'jgw_word_embeddings_' + str(WORD_EMBEDDING_DIM)), embeddings)
