...
if __name__ == '__main__':
    ...
    entity2index = read_map(prefix + 'minidata_entity2index.txt')
    full_entity2index = read_map(prefix + 'minidata_entity2id.txt')
    entity2neighbor = get_neighbors_for_entity(prefix + 'minidata_triple2id.txt')
    ...
    full_embeddings = np.loadtxt(prefix + 'minidata_' + KGE_METHOD + '_entity2vec_' + str(ENTITY_EMBEDDING_DIM) + '.vec')
    ...
    np.save(prefix + 'minidata_' + 'entity_embeddings_' + KGE_METHOD + '_' + str(ENTITY_EMBEDDING_DIM), entity_embeddings)
    np.save(prefix + 'minidata_' +'context_embeddings_' + KGE_METHOD + '_' + str(ENTITY_EMBEDDING_DIM), context_embeddings)
