...
D = pd.read_csv('../ccks2019/event_type_entity_extract_train.csv', encoding='utf-8', header=None)
D = D[D[2] != u'其他']
...
D = pd.read_csv('../ccks2019/event_type_entity_extract_eval.csv', encoding='utf-8', header=None)
test_data = []
...
ps1 = Lambda(lambda x: x[0][..., 0] - (1 - x[1][..., 0]) * 1e10)([ps1, x_mask])#对于输入的编码成0或小于0的东西要求预测的时候给很高值？
